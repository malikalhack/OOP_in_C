...
/********************************* Entry point ********************************/
int main(void) {
    Rectangle r1, r2; /* multiple instances of Coordinate */
    ...
    printf("[INFO] Width limited by %3u\n", WIDTH_LIMIT);
    {
        ...
        fflush(stdout);
        scanf("%hu", &l);
        Rectangle_ctor(&r1, X_CENTER, Y_CENTER, w, l);
        ...
        fflush(stdout);
        scanf("%hu", &l);
        Rectangle_ctor(&r2, X_CENTER, Y_CENTER, w, l);
    }
    printf(
        "\nThe initial coordinates of the point r1(x: %3u, y: %3u)\n",
        GetXCoordinate(SUPER_UPCAST(&r1)),
        GetYCoordinate(SUPER_UPCAST(&r1))
    );
    printf(
        "The initial coordinates of the point r2(x: %3u, y: %3u)\n\n",
...
/*----------------------------------------------------------------------------*/
    ...
    StandInTheLowerLeftCorner(SUPER_UPCAST(&r1));
    StandInTheLowerLeftCorner(SUPER_UPCAST(&r2));
    PrintCoordinatesOfBothRectangles(&r1, &r2);
    TEST_FINISH;
    /*----------------------------------------------------------------------------*/
    TEST_START("moving to the upper left corner of the area");
    StandInTheUpperLeftCorner(SUPER_UPCAST(&r1));
    StandInTheUpperLeftCorner(SUPER_UPCAST(&r2));
    PrintCoordinatesOfBothRectangles(&r1, &r2);
    TEST_FINISH;
    /*----------------------------------------------------------------------------*/
    TEST_START("moving to the lower right corner of the area");
    StandInTheLowerRightCorner(SUPER_UPCAST(&r1));
    StandInTheLowerRightCorner(SUPER_UPCAST(&r2));
    PrintCoordinatesOfBothRectangles(&r1, &r2);
    TEST_FINISH;
    /*----------------------------------------------------------------------------*/
    TEST_START("moving to the upper right corner of the area");
    StandInTheUpperRightCorner(SUPER_UPCAST(&r1));
    StandInTheUpperRightCorner(SUPER_UPCAST(&r2));
    PrintCoordinatesOfBothRectangles(&r1, &r2);
    TEST_FINISH;
    /*----------------------------------------------------------------------------*/
    TEST_START("returning to the centre of the area");
    StandInTheCenter(SUPER_UPCAST(&r1));
    StandInTheCenter(SUPER_UPCAST(&r2));
    PrintCoordinatesOfBothRectangles(&r1, &r2);
    TEST_FINISH;
    ...
    do {
        ...
        printf("Enter coordinates for point r1:\nx: ");
        fflush(stdout);
        scanf_s("%hu", &x);
        printf("y: ");
        fflush(stdout);
        ...
        printf("\nEnter coordinates for point r2:\nx: ");
        fflush(stdout);
        scanf_s("%hu", &x);
        printf("y: ");
        fflush(stdout);
        ...
        printf("Enter offset for point r1:\nx: ");
        fflush(stdout);
        scanf(" %hd", &xof);
        printf("y: ");
        fflush(stdout);
...
static void PrintCoordinatesOfBothRectangles(
    ...
    printf(
        "Current coordinates of the centre are (x: %3u; y: %3u)\n",
        GetXCoordinate(SUPER_UPCAST(r1)),
        GetYCoordinate(SUPER_UPCAST(r1))
    );
